...
/*
This code will light up each LED in the grid in sequence from the left to right,
with a delay of 100 milliseconds between each LED. The color of the LED will be
set to red, but you can change this to any color you like by using a different
color constant from the CRGB class (e.g. CRGB::Blue for blue, CRGB::Green for
green, etc.).
*/